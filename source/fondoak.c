...
void erakutsiBatalla() {
    ...
    dmaCopyHalfWords(DMA_CHANNEL,
                     batallaBiBitmap, /* Automatikoki sortzen den aldagaia */
...
void erakutsiIrabaziFondoa() {
    ...
    dmaCopyHalfWords(DMA_CHANNEL,
                     IrabaziFondoaBiBitmap, /* Automatikoki sortzen den aldagaia */
                     (uint16 *)BG_BMP_RAM(0), /* Fondo nagusiaren helbidea */
...
void erakutsiGalduFondoa() {
    ...
    dmaCopyHalfWords(DMA_CHANNEL,
                     GalduFondoaBiBitmap, /* Automatikoki sortzen den aldagaia */
                     (uint16 *)BG_BMP_RAM(0), /* Fondo nagusiaren helbidea */
...
void erakutsiMenu() {
    ...
    dmaCopyHalfWords(DMA_CHANNEL,
                     MenuBiBitmap, /* Automatikoki sortzen den aldagaia */
                     (uint16 *)BG_BMP_RAM(0), /* Fondo nagusiaren helbidea */
...
void erakutsiIstorioa() {
    ...
    dmaCopyHalfWords(DMA_CHANNEL,
                     IstorioaBiBitmap, /* Automatikoki sortzen den aldagaia */
                     (uint16 *)BG_BMP_RAM(0), /* Fondo nagusiaren helbidea */
